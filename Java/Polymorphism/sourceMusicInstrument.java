...
class Guitar extends MusicInstrument {
    ...
    void display() {
        ...
        System.out.println("Guitar Type: " + this.guitarType);
    }
    void play() {
...
class Tabla extends MusicInstrument {
    ...
    void display() {
        super.display();
        System.out.println("Dayan Diameter: " + this.dayanDiameter);
        System.out.println("Bayan Diameter: " + this.bayanDiameter);
        System.out.println("Skin Material: " + this.skinMaterial);
    }
    void play() {
