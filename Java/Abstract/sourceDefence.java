...
abstract class Defence {
	...
	void attack() {
		System.out.println(this.manpowerCount);
	}
...
class Army extends Defence{
	...
	void attack() {
		System.out.println("Manpower is:- "+this.manpowerCount+" Attack with Tanks:- "+this.noOfTanks+" Guns:- "+this.noOfGuns);
	}
	public String toString() {
		return "Name of head:- " + this.nameOfHead + " Country:- " + this.countryName + " Headquarters Location:- " + this.locationOfHeadquarters + " Troops:- " + this.noOfTroops + " Departments:- " + this.noOfDept + " Vehicles:- " + this.noOfVehicles + " Manpower:- " + this.manpowerCount + " Bases:- " + this.noOfBases + " Casualties:- " + this.noOfCasualties + " Missions Performed:- " + this.noOfMissionsPerformed + " Budget:- " + this.budget + " Tanks:- " + this.noOfTanks + " Guns:- " + this.noOfGuns + " Regiments:- " + this.noOfRegiments + " Battalions:- " + this.noOfBattalions;
	}
...
class Navy extends Defence{
	...
	void attack() {
		System.out.println("Manpower is:- "+this.manpowerCount+" attack with torpedoes:- "+this.noOfTorpedoes);
	}
	
	public String toString() {
		return "Name of head:- " + this.nameOfHead + " Country:- " + this.countryName + " Headquarters Location:- " + this.locationOfHeadquarters + " Troops:- " + this.noOfTroops + " Departments:- " + this.noOfDept + " Vehicles:- " + this.noOfVehicles + " Manpower:- " + this.manpowerCount + " Bases:- " + this.noOfBases + " Casualties:- " + this.noOfCasualties + " Missions Performed:- " + this.noOfMissionsPerformed + " Budget:- " + this.budget + " Ships:- " + this.noOfShips + " Submarines:- " + this.noOfSubmarines + " Torpedoes:- " + this.noOfTorpedoes;
...
class Air extends Defence{
	...
	void attack() {
		System.out.println("Manpower is:- "+this.manpowerCount+" attack With Missiles are:- "+this.noOfMissiles);
	}
	public String toString() {
		return "Name of head:- " + this.nameOfHead + " Country:- " + this.countryName + " Headquarters Location:- " + this.locationOfHeadquarters + " Troops:- " + this.noOfTroops + " Departments:- " + this.noOfDept + " Vehicles:- " + this.noOfVehicles + " Manpower:- " + this.manpowerCount + " Bases:- " + this.noOfBases + " Casualties:- " + this.noOfCasualties + " Missions Performed:- " + this.noOfMissionsPerformed + " Budget:- " + this.budget + " Missiles:- " + this.noOfMissiles + " Aircraft:- " + this.aircraft + " Squadrons:- " + this.noOfSquadrons;
...
class testDefence{
	public static void main(String[] args) {
		Defence d1;//Generalize reference
		d1=new Army("General Karan Mehta","India","Pune",160000,4,10000,220000,28,280,130,5500000000L,4000,8500,55,210);
		System.out.println(d1);
		d1.attack();
		System.out.println();
		d1=new Navy("Admiral Rajesh Menon","India","Mumbai",90000,3,8000,150000,20,200,110,4500000000L,130,25,350);
		System.out.println(d1);
		d1.attack();
		System.out.println();
		d1=new Air("Air Marshal Dev Sharma","India","Bangalore",120000,4,9000,180000,22,230,115,4800000000L,1200,270,18);
		System.out.println(d1);
		d1.attack();
		System.out.println();
	}
