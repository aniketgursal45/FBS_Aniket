...
abstract class Artist {
    ...
    void display() {
        System.out.println("Name:- " + this.name+" Gender:- " + this.gender+" Famous Work:- " + this.famousWork+" Age:- " + this.age+" Experience (years):- " + this.experience);
    }
    void perform() {
...
class Singer extends Artist {
    ...
    public String toString() {
    	return "Name:- " + this.name+" Gender:- " + this.gender+" Famous Work:- " + this.famousWork+" Age:- " + this.age+" Experience (years):- " + this.experience +"Number of Songs:- " + this.noOfSongs+" Genre:- " + this.genre+" Has Award:- " + this.hasAward;
    }
    void perform() {
...
class Painter extends Artist {
    ...
    public String toString() {
    	return "Name:- " + this.name+" Gender:- " + this.gender+" Famous Work:- " + this.famousWork+" Age:- " + this.age+" Experience (years):- " + this.experience +"Number of Songs:- " + "Painting Style:- " + this.style+" Medium:- " + this.medium+" No. of Paintings:- " + this.noOfPaintings;
    }
    void perform() {
...
class Actor extends Artist {
    ...
    public String toString() {
    	return "Name:- " + this.name+" Gender:- " + this.gender+" Famous Work:- " + this.famousWork+" Age:- " + this.age+" Experience (years):- " + this.experience +"No. of Movies:- " + this.noOfMovies+ " Acting Style:- " + this.actingStyle+" Is Famous:- " + this.isFamous;
    }
